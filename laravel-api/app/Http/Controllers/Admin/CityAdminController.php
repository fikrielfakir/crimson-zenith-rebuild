...
class CityAdminController extends Controller
{
    private function mapOutput(City $city): array
    {
        return [
            ...
            'image'        => $city->image,
            'heroType'    => $city->hero_type ?? 'image',
            'heroVideo'   => $city->hero_video ?? '',
            'heroOverlay' => $city->hero_overlay ?? 50,
    ...
    private function mapInput(Request $request): array
    {
        ...
        return array_filter([
            ...
            'hero_type'    => $request->input('heroType', 'image'),
            'hero_video'   => $request->input('heroVideo', ''),
            'hero_overlay' => (int) $request->input('heroOverlay', 50),
