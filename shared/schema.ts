...
export const users = pgTable("users", {
  ...
  interests: json("interests").default(sql`'[]'::jsonb`),
...
export const clubs = pgTable("clubs", {
  ...
  features: json("features").default(sql`'[]'::jsonb`),
  contactPhone: varchar("contact_phone", { length: 50 }),
  contactEmail: varchar("contact_email", { length: 255 }),
  website: varchar("website", { length: 500 }),
  socialMedia: json("social_media").default(sql`'{}'::jsonb`),
...
export const bookingEvents = pgTable("booking_events", {
  ...
  languages: json("languages").default(sql`'["English"]'::jsonb`),
  ageRange: varchar("age_range", { length: 100 }),
  groupSize: varchar("group_size", { length: 100 }),
  cancellationPolicy: text("cancellation_policy"),
  images: json("images").default(sql`'[]'::jsonb`),
  highlights: json("highlights").default(sql`'[]'::jsonb`),
  included: json("included").default(sql`'[]'::jsonb`),
  notIncluded: json("not_included").default(sql`'[]'::jsonb`),
  schedule: json("schedule").default(sql`'[]'::jsonb`),
  isActive: boolean("is_active").default(true),
  createdBy: varchar("created_by", { length: 255 }).references(() => users.id),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
...
export const heroSettings = pgTable("hero_settings", {
  ...
  typewriterTexts: json("typewriter_texts").default(sql`'[]'::jsonb`),
  updatedBy: varchar("updated_by", { length: 255 }).references(() => users.id),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const sectionBlocks = pgTable("section_blocks", {
  ...
  ordering: integer("ordering").default(0).notNull(),
  content: json("content").default(sql`'{}'::jsonb`).notNull(),
  isActive: boolean("is_active").default(true),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const contactSettings = pgTable("contact_settings", {
  ...
  formRecipients: json("form_recipients").default(sql`'[]'::jsonb`),
...
export const footerSettings = pgTable("footer_settings", {
  ...
  description: text("description"),
  links: json("links").default(sql`'[]'::jsonb`),
  socialLinks: json("social_links").default(sql`'{}'::jsonb`),
