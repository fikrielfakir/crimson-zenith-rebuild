...
export const themeSettings = pgTable("theme_settings", {
  ...
  primaryColor: varchar("primary_color", { length: 50 }).default("#112250"),
  secondaryColor: varchar("secondary_color", { length: 50 }).default("#D8C18D"),
  accentColor: varchar("accent_color", { length: 50 }).default("#E63946"),
  backgroundColor: varchar("background_color", { length: 50 }).default("#FFFFFF"),
  textColor: varchar("text_color", { length: 50 }).default("#1A202C"),
  headingFont: varchar("heading_font", { length: 100 }).default("Poppins"),
  bodyFont: varchar("body_font", { length: 100 }).default("Inter"),
  h1Size: varchar("h1_size", { length: 20 }).default("64px"),
  h2Size: varchar("h2_size", { length: 20 }).default("48px"),
  h3Size: varchar("h3_size", { length: 20 }).default("32px"),
  bodySize: varchar("body_size", { length: 20 }).default("16px"),
  smallSize: varchar("small_size", { length: 20 }).default("14px"),
  sectionPadding: varchar("section_padding", { length: 20 }).default("80"),
  cardBorderRadius: varchar("card_border_radius", { length: 20 }).default("12"),
  buttonBorderRadius: varchar("button_border_radius", { length: 20 }).default("8"),
  customCss: text("custom_css"),
...
export const heroSettings = pgTable("hero_settings", {
  ...
  showPrimaryButton: boolean("show_primary_button").default(true),
  showSecondaryButton: boolean("show_secondary_button").default(true),
  titleAlignment: varchar("title_alignment", { length: 20 }).default("center"),
  subtitleAlignment: varchar("subtitle_alignment", { length: 20 }).default("center"),
...
export const aboutSettings = pgTable("about_settings", {
  ...
  subtitle: text("subtitle"),
  description: text("description").notNull(),
  whoWeAreTitle: varchar("who_we_are_title", { length: 255 }),
  whoWeAreParagraph2: text("who_we_are_paragraph2"),
  valuesTitle: varchar("values_title", { length: 255 }),
  values: jsonb("values"),
