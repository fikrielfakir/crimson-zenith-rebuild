...
export default function WorkOffersAdmin() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: editing ? t('admin.workOffers.toastUpdated') : t('admin.workOffers.toastCreated') });
      setDialogOpen(false);
    },
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['admin-work-offers'] });
      toast({ title: t('admin.workOffers.toastDeleted') });
      setDeletingId(null);
    },
    onError: (e: Error) => toast({ title: t('admin.common.errorTitle'), description: e.message, variant: 'destructive' }),
  });
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t('admin.common.salary')}</TableHead>
