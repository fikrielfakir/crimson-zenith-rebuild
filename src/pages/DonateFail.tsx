...
export default function DonateFail() {
          ...
          <CardContent className="p-8 space-y-6">
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              <p className="text-sm text-red-800">
                Your transaction was declined or cancelled. You have not been charged.
                {ref && (
            ...
            <div className="space-y-3">
              <Button
                ...
                className="w-full bg-[#D4B26A] hover:bg-[#C9A758] text-white font-['Poppins'] font-semibold py-6 rounded-xl"
              >
              ...
              <Link to="/" className="block">
                <Button
                  variant="outline"
                  className="w-full font-['Poppins'] font-semibold py-6 rounded-xl border-2"
                >
